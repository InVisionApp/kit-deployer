  ...
  describe("when called", function() {
    ...
    var hasDependenciesAssertions = function(context) {
      ...
      it("should log detected dependencies", function() {
        expect(onDebug).to.have.been.calledWith(
          "Dependency detected for " +
            context.manifest.metadata.name +
            " <= " +
      ...
      it("should call kubectl with desired 'selector'", function() {
        ...
        expect(kubectlListSpy).to.have.been.calledWith(
          "deployment,service,secret,job",
          manifestDependencies
        );
      });
    ...
    var availableDependenciesAssertions = function(context) {
      ...
      describe("and all kubectl request are successful", function() {
        ...
        it("should log dependencies as available", function() {
          expect(onInfo).to.have.been.calledWith(
            "Dependency available for " +
              context.manifest.metadata.name +
              " <= " +
              manifestDependencies
          );
    ...
    var scenarios = {
      "manifest with no dependencies": {
        ...
        after: function() {
          ...
          it("should resolve instantly", function() {
            return dependencies.ready(self.manifest).then(function(res) {
      ...
      "mainfest with single service dependency": {
        ...
        kubectlListResponse: [{ kind: "Service", status: "service1" }],
        after: function() {
          var self = this;
      ...
      "mainfest with single secret dependency": {
        ...
        kubectlListResponse: [{ kind: "Service", status: "secret1" }],
        after: function() {
          var self = this;
          hasDependenciesAssertions(self);
          availableDependenciesAssertions(self);
      ...
      "mainfest with multiple secret dependencies": {
        manifest: {
          ...
          metadata: {
            name: "main-deployment",
            annotations: {
              "kit-deployer/dependency-selector":
                "my-secret,second-secret,third-secret"
            }
          }
        },
        kubectlListResponse: [
      ...
      "mainfest with multiple deployment dependencies that are available": {
        manifest: {
          ...
          metadata: {
            ...
            annotations: {
              "kit-deployer/dependency-selector":
                "my-deployment,second-deployment"
            }
          }
        },
        kubectlListResponse: [
      ...
      "mainfest with multiple mixed dependencies that are available": {
        manifest: {
          ...
          metadata: {
            ...
            annotations: {
              "kit-deployer/dependency-selector":
                "my-job,my-deployment,my-service"
            }
          }
        },
        kubectlListResponse: [
