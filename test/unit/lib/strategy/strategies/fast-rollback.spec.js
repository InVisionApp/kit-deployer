        ...
        describe("and allAvailable is called", () => {
          ...
          describe("and pods match selector in cluster", () => {
            ...
            it("should call apply", () => {
              ...
              expect(kubectlApplySpy).to.have.been.calledWith(
                tmpApplyingConfigurationPath
              );
            });
          });
      ...
      describe("and there are deployments", () => {
        it("should delete correct deployments", () => {
          ...
          return strategy.deleteBackups().then(res => {
            ...
            expect(kubectlGetSpy).to.have.been.calledWith(
              "deployment",
              "test-deployment-dep-1"
            );
            expect(kubectlListSpy).to.have.been.calledOnce;
            expect(kubectlListSpy).to.have.been.calledWith(
              "deployments",
              "name=test-deployment,id!=dep-1,strategy=fast-rollback"
            );
            ...
            expect(kubectlDeleteByNameSpy).to.have.been.calledWith(
              "deployment",
              "test-deployment-dep-5"
            );
            expect(kubectlDeleteByNameSpy).to.have.been.calledWith(
              "deployment",
              "test-deployment-dep-6"
            );
          });
        });
      });
      ...
      describe("and there are deployments", () => {
        it("should delete correct deployments", () => {
          ...
          return strategy.deleteNewer().then(res => {
            ...
            expect(kubectlDeleteByNameSpy).to.have.been.calledWith(
              "deployment",
              "test-deployment-dep-2"
            );
            expect(kubectlDeleteByNameSpy).to.have.been.calledWith(
              "deployment",
              "test-deployment-dep-3"
            );
          });
        });
      });
